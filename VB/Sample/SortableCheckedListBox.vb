...
Namespace Sample
	...
	Public Class CustomCheckedListBoxViewInfo
		...
		Public Class CustomCheckedItemInfo
			...
			Public Sub New(ByVal rect As Rectangle, ByVal item As Object, ByVal text As String, ByVal index As Integer, ByVal checkState As CheckState, ByVal enabled As Boolean)
				MyBase.New(rect, item, text, index, checkState, enabled)
				DropLine()
			End Sub
			Public Sub New(ByVal info As CheckedItemInfo)
				Me.New(info.Bounds, info.Item, info.Text, info.Index, info.CheckArgs.CheckState, info.Enabled)
