	...
	Public Class CustomGridPainter
		...
		Protected Overridable Sub DrawQuickCustomisationIconCore(ByVal e As GridViewDrawArgs, ByVal info As IndicatorObjectInfoArgs, ByVal icon As QuickCustomizationIcon, ByVal bounds As Rectangle, ByVal status As QuickCustomisationIconStatus)
			...
			If icon.Image IsNot Nothing Then
				...
				e.Cache.Paint.DrawImage(e.Cache.Graphics, icon.Image, rec)
			End If
		End Sub
	End Class
...
'INSTANT VB NOTE: The variable allowQuickCustomisation was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable image was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private image_Renamed As Image
'INSTANT VB NOTE: The variable transperentColor was renamed since Visual Basic does not allow variables and other class members to have the same name:
