...
'INSTANT VB NOTE: The variable columns was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable editorHeight was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private Const editorWidth As Integer = 10, editorHeight_Renamed As Integer = 11
'INSTANT VB NOTE: The variable gridView was renamed since Visual Basic does not allow variables and other class members to have the same name:
	...
	Public Class QuickHideEditPainter
		...
		Protected Overrides Sub DrawContent(ByVal info As ControlGraphicsInfoArgs)
			...
			If icon.Image IsNot Nothing Then
				...
				info.Cache.Paint.DrawImage(info.Cache.Graphics, icon.Image, info.ViewInfo.ClientRect)
			End If
		End Sub
	End Class
